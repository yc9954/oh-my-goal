...
function artifactMap({ objective, slug, route, answers }) {
  ...
  return {
    'context-index.md': lines([
      ...
      '5. `execution-spec.md`',
      '6. `harness.md`',
      '7. `runtime-commands.md`',
      '8. `agents.md`',
      '9. `orchestration.md`',
      '10. `team-system.md`',
      '11. `worker-packet-template.md`',
      '12. `trajectory-ledger.md`',
      '13. `state-ledger.md`',
      '14. `local-optimum-pressure.md`',
      '15. `completion-gate.md`',
      '',
    ...
    'orchestration.md': lines([
      ...
      '2. Leader reads `execution-spec.md` and maps requirements to worker lanes.',
      '3. Architect and critic propose competing trajectories.',
      '4. Implementer executes the selected trajectory.',
      '5. Tester runs verification and records output.',
      '6. Critic challenges completion.',
      '7. Leader updates the Codex goal only after the completion gate passes.',
      '',
      'Planning voices:',
