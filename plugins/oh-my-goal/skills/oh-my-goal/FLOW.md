...
| `INTAKE_ANSWERED` | `flows/02-artifact-generation.md` | assimilate answers, verify residual ambiguity is low enough and quality pruning is complete, generate harness | invent missing answers silently |
