...
Generate intake from the OMX-style runtime in `auto` mode. In attached tmux, this opens the ↑↓/Space/Enter selector pane and returns structured answers. In Codex text surfaces, it returns the next single-question prompt.
